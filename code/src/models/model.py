...
from torch_geometric.nn import GCNConv, SAGEConv, GATConv, GMMConv
import torch.nn.functional as F

# %%
n_feats = 3400

class GNN_bak(nn.Module):
    def __init__(self):
        ...
        # self.adapt = nn.AdaptiveMaxPool1d(512)
        self.w0 = nn.Linear(n_feats, 512)
